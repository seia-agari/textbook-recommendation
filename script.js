...
const HS_LIB = {
  ...
  modern: {
    L1: [
      {
        title: "『現代文読解キーワード』＋『現代文100字要約ドリル 基礎編』",
        tags: ["読解キーワードと要約"],
        why: "現代文の頻出テーマや要旨把握の型を最初に身につけることで、設問処理が安定する。",
        tip: "キーワード暗記＋要約練習を並行。本文の主張・根拠・対比を抜き出して1文にまとめる練習。"
      },
      {
        title: "『新・現代文レベル別問題集1,2』",
        tags: ["問題集"],
        why: "共通テストレベルの基礎問題を通して正確さとスピードを両立。",
        tip: "解答根拠を必ず本文行でチェックし、誤答は原因ラベルをつけて復習。"
      }
    ],
    L2: [
      {
        title: "『新・現代文レベル別問題集3,4』",
        tags: ["問題集"],
        why: "情報量が多い評論や小説でも要旨把握を崩さず正確に設問に答える訓練。",
        tip: "本文構造をマーク（対比・具体例・譲歩）→設問の根拠を本文行に必ず書き出す。"
      }
    ],
    L3: [
      {
        title: "『新・現代文レベル別問題集5』",
        tags: ["問題集"],
        why: "難関私大レベルの抽象評論や多段設問に対応できる力を養成。",
        tip: "設問先読み→本文精読→選択肢検証を徹底し、タイムマネジメントを意識。"
      }
    ],
    L4: [
      {
        title: "『新・現代文レベル別問題集6』＋『上級現代文』（発展）",
        tags: ["問題集"],
        why: "比喩・反事実・複線構造を含む超難問を通して読みの深度と論理展開の追跡力を完成させる。",
        tip: "本文構造図（主張・根拠・反論・再主張）を必ず書き出してから解答。"
      }
    ]
  },
  classic: {
    L1: [{
      title: "『学校配布の古文単語』＋『ベーシック古典』",
      tags: ["単語・文法"],
      why: "古文単語と学校で習った文法を中心に基礎固め。",
      tip: "毎回少しずつ単語・文法を復習し、短文読解で定着させる。"
    },
    {
      title: "『古文レベル別問題集1,2』",
      tags: ["問題集"],
      why: "内容を復習しつつ新しい範囲も着実に理解しながら問題を解く。",
      tip: "学校の授業進度に合わせて文法を確認し、短文読解でアウトプット。"
    },],
    L2: [{
      title: "『学校配布の古文単語』＋『ベーシック古典』",
      tags: ["単語・文法"],
    ...
    L3: [{
      title: "『学校配布の古文単語』＋『ベーシック古典』",
      tags: ["単語・文法"],
      why: "内容を復習しつつ新しい範囲も着実に理解。",
      tip: "学校の授業進度に合わせて文法を確認し、短文読解でアウトプット。"
    },
    {
      title: "『古文レベル別問題集5』",
      tags: ["問題集"],
      why: "基礎を固めた上で得点力を高めるために演習を開始。",
      tip: "得点力はここで鍛えよう"
    },
    {
      title: "『マドンナ古文常識」",
      tags: ["古文常識"],
      why: "古文の世界の常識を知ろう",
      tip: "現代と過去の文化、システム、感じ方、楽しみ方、古文のテンプレを覚えよう"
    },],
    L4: [{
      title: "『マドンナ古文常識」",
      tags: ["古文常識"],
  ...
  kanbun: {
    L1: [{
      title: "『漢文早覚え速答法』＋『漢文句形とキーワード』",
      tags: ["全学年共通"],
      why: "基本的句形を確実に覚えることで読解スピードと正答率を上げる。",
      tip: "句形の例文を繰り返し音読・暗唱して定着させる。"
    }],
    L2: [{
      title: "『漢文早覚え速答法』＋『漢文句形とキーワード』",
      tags: ["全学年共通"],
