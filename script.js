const allQuestionsData = { english: { 観点: ["単語・語彙", "文法(基礎)", "文法(応用)", "並び替え", "長文読解", "対話文"], 平均: [60, 65, 55, 70, 50, 65], grade1: [ { q: "問1. 「りんご」を英語で何と言いますか？", options: ["apple", "orange", "banana"], a: "apple", c: "単語・語彙" }, { q: "問2. 'This is ( ) pen.' ( )に入るのは？", options: ["a", "an", "the"], a: "a", c: "文法(基礎)" }, { q: "問3. 「ねこ」を英語で何と言いますか？", options: ["cat", "dog", "bird"], a: "cat", c: "単語・語彙" }, { q: "問4. 'I ( ) a student.' ( )に入るのは？", options: ["am", "is", "are"], a: "am", c: "文法(基礎)" }, { q: "問5. 「黄色」を英語で何と言いますか？", options: ["yellow", "red", "blue"], a: "yellow", c: "単語・語彙" }, { q: "問6. 'I like ( ).' ( )に入る最も自然なのは？", options: ["apples", "an apple", "apple"], a: "apples", c: "文法(応用)" }, { q: "問7. 'What's your name?' と聞かれた時の答えは？", options: ["My name is Mike.", "I am Mike.", "This is Mike."], a: "My name is Mike.", c: "対話文" }, { q: "問8. 'book' の複数形は何ですか？", options: ["books", "bookes", "boox"], a: "books", c: "文法(基礎)" }, { q: "問9. 'How are you?' と聞かれた時の答えは？", options: ["I'm fine, thank you.", "I'm Mike.", "I'm ten."], a: "I'm fine, thank you.", c: "対話文" }, { q: "問10. 'It's sunny.' はどんな意味ですか？", options: ["晴れている", "雨が降っている", "雪が降っている"], a: "晴れている", c: "単語・語彙" }, { q: "問11. 「1, 2, 3」を英語で言うと？", options: ["one, two, three", "A, B, C", "do, re, mi"], a: "one, two, three", c: "単語・語彙" }, { q: "問12. 'I can ( ) the piano.' ( )に入るのは？", options: ["play", "plays", "playing"], a: "play", c: "文法(応用)" }, { q: "問13. ( is / this / a / book ).' を並び替えて「これは本です。」という文を完成させなさい。", type: "sort", a: "This is a book.", c: "並び替え" }, { q: "問14. ( my / is / mother / she ).' を並び替えて「彼女は私のお母さんです。」という文を完成させなさい。", type: "sort", a: "She is my mother.", c: "並び替え" }, { q: "問15. 次の文を読んで質問に答えなさい。\n'I have a dog. His name is Max. He is very cute. He likes to play.'\nMaxは何が好きですか？", options: ["遊ぶこと", "寝ること", "食べること"], a: "遊ぶこと", c: "長文読解" }, { q: "問16. 'Let's play soccer.' はどんな意味ですか？", options: ["サッカーをしよう", "勉強しよう", "家に帰ろう"], a: "サッカーをしよう", c: "対話文" }, { q: "問17. 'Where are you from?' と聞かれた時の答えは？", options: ["I'm from Japan.", "I'm hungry.", "It's a pen."], a: "I'm from Japan.", c: "対話文" }, { q: "問18. 'Happy birthday!' はいつ使う言葉ですか？", options: ["誕生日", "新年", "クリスマス"], a: "誕生日", c: "単語・語彙" }, { q: "問19. 'Thank you.' と言われた時の返事は？", options: ["You're welcome.", "Good bye.", "Hello."], a: "You're welcome.", c: "対話文" }, { q: "問20. 次の文を読んで質問に答えなさい。\n'My name is Yumi. I go to school by bus every day. I like music and I play the piano.'\nユミはどうやって学校に行きますか？", options: ["バスで", "歩いて", "自転車で"], a: "バスで", c: "長文読解" } ], grade2: [ { q: "問1. '私は学生です' を英語で書きなさい。", options: ["I am a student.", "I is a student.", "I are a student."], a: "I am a student.", c: "文法(基礎)" }, { q: "問2. 'Do you ( ) a pen?' ( )に入るのは？", options: ["have", "has", "are"], a: "have", c: "文法(基礎)" }, { q: "問3. 'watch' の三単現の形は？", options: ["watches", "watchs", "watching"], a: "watches", c: "文法(基礎)" }, { q: "問4. 'library' の意味は？", options: ["図書館", "公園", "駅"], a: "図書館", c: "単語・語彙" }, { q: "問5. 'Where ( ) you from?' ( )に入るのは？", options: ["are", "is", "do"], a: "are", c: "文法(基礎)" }, { q: "問6. 'He can speak English ( ).' ( )に入るのは？", options: ["well", "good", "better"], a: "well", c: "文法(応用)" }, { q: "問7. 'Excuse me?' と言われた時の返事は？", options: ["Yes?", "Thank you.", "You're welcome."], a: "Yes?", c: "対話文" }, { q: "問8. ( you / do / like / music / ? ).' を並び替えて「あなたは音楽が好きですか？」という文を完成させなさい。", type: "sort", a: "Do you like music?", c: "並び替え" }, { q: "問9. 'Don't run in the classroom.' はどんな意味ですか？", options: ["教室で走ってはいけません。", "教室で勉強しなさい。", "教室で静かにしなさい。"], a: "教室で走ってはいけません。", c: "文法(基礎)" }, { q: "問10. 'month' の意味は？", options: ["月", "年", "週"], a: "月", c: "単語・語彙" }, { q: "問11. 'I play tennis.' を否定文にしなさい。", options: ["I don't play tennis.", "I am not play tennis.", "I not play tennis."], a: "I don't play tennis.", c: "文法(基礎)" }, { q: "問12. 'What time is it?' の答えとして正しいのは？", options: ["It's ten thirty.", "I'm ten.", "He is ten."], a: "It's ten thirty.", c: "対話文" }, { q: "問13. ( is / your / what / favorite / subject / ? ).' を並び替えて「あなたの好きな教科は何ですか？」という文を完成させなさい。", type: "sort", a: "What is your favorite subject?", c: "並び替え" }, { q: "問14. 'Let's go to the park.' と誘われた時の承諾の返事は？", options: ["Yes, let's.", "No, thank you.", "I'm sorry."], a: "Yes, let's.", c: "対話文" }, { q: "問15. 次の文を読んで質問に答えなさい。\n'This is Ken. He is from Canada. He likes Japanese food, for example, sushi and ramen. He can't use chopsticks well, but he is practicing.'\nケンが上手に使えないものは何ですか？", options: ["箸", "フォーク", "スプーン"], a: "箸", c: "長文読解" }, { q: "問16. 'I have ( ) brothers.' 2人の兄がいる場合、( )に入るのは？", options: ["two", "to", "too"], a: "two", c: "単語・語彙" }, { q: "問17. 'study' の過去形は？", options: ["studied", "studed", "studyed"], a: "studied", c: "文法(基礎)" }, { q: "問18. 'I ( ) to school yesterday.' ( )に入るのは？", options: ["went", "go", "goes"], a: "went", c: "文法(基礎)" }, { q: "問19. 'Whose pen is this?' の答えとして正しいのは？", options: ["It's mine.", "This is a pen.", "Yes, it is."], a: "It's mine.", c: "対話文" }, { q: "問20. ( play / can / you / the / guitar / ? ).' を並び替えて「あなたはギターが弾けますか？」という文を完成させなさい。", type: "sort", a: "Can you play the guitar?", c: "並び替え" } ], grade3: [ { q: "問1. He is going to ( ) a book.", options: ["read", "reads", "reading"], a: "read", c: "文法(基礎)"}, { q: "問2. I was ( ) TV at that time.", options: ["watch", "watches", "watching"], a: "watching", c: "文法(応用)"}, { q: "問3. There are many ( ) in the park.", options: ["people", "person", "peoples"], a: "people", c: "単語・語彙"}, { q: "問4. If it ( ) tomorrow, I will stay home.", options: ["rain", "rains", "is raining"], a: "rains", c: "文法(応用)"}, { q: "問5. A: Must I do my homework now? B: No, you ( ).", options: ["don't have to", "must not", "may not"], a: "don't have to", c: "対話文"}, { q: "問6. To ( ) a foreign language is difficult.", options: ["learn", "learning", "learned"], a: "learn", c: "文法(基礎)"}, { q: "問7. 'information'の意味は？", options: ["情報", "招待", "発明"], a: "情報", c: "単語・語彙"}, { q: "問8. ( to / I / the park / went / play / soccer / to ).' を並び替えて「私はサッカーをするために公園へ行きました。」という文を完成させなさい。", type: "sort", a: "I went to the park to play soccer.", c: "並び替え"}, { q: "問9. This book is ( ) interesting than that one.", options: ["more", "most", "as"], a: "more", c: "文法(応用)"}, { q: "問10. 'I was excited to hear the news.' と同じ意味の文は？", options: ["The news excited me.", "I excited the news.", "The news was excited."], a: "The news excited me.", c: "文法(応用)"}, { q: "問11. 'He is the ( ) runner in our class.' (一番速い)", options: ["fastest", "faster", "fast"], a: "fastest", c: "文法(応用)"}, { q: "問12. 'important'の意味は？", options: ["重要な", "簡単な", "面白い"], a: "重要な", c: "単語・語彙"}, { q: "問13. 'I'll call you when I ( ) home.' ( )に入るのは？", options: ["get", "will get", "got"], a: "get", c: "文法(基礎)"}, { q: "問14. A: How was your weekend? B: ( )", options: ["It was great.", "It is great.", "It will be great."], a: "It was great.", c: "対話文"}, { q: "問15. 次の文を読んで質問に答えなさい。\n'Last Sunday, I went to the zoo with my family. I saw many animals, like lions, giraffes, and monkeys. The monkeys were very funny. They were eating bananas. I had a very good time there.'\n私が動物園で見た一番面白い動物は何でしたか？", options: ["サル", "ライオン", "キリン"], a: "サル", c: "長文読解"}, { q: "問16. 'You must ( ) your homework.' ( )に入るのは？", options: ["do", "to do", "doing"], a: "do", c: "文法(基礎)"}, { q: "問17. 'receive'の意味は？", options: ["受け取る", "送る", "忘れる"], a: "受け取る", c: "単語・語彙"}, { q: "問18. ( traveling / by / like / I / train ).' を並び替えて「私は電車で旅をするのが好きです。」という文を完成させなさい。", type: "sort", a: "I like traveling by train.", c: "並び替え"}, { q: "問19. 'I am looking for my key.' はどんな意味ですか？", options: ["私は鍵を探しています。", "私は鍵を見つけました。", "私は鍵を失くしました。"], a: "私は鍵を探しています。", c: "単語・語彙"}, { q: "問20. This is the ( ) picture in this museum. (最も有名)", options: ["most famous", "more famous", "famous"], a: "most famous", c: "文法(応用)"} ] }, math: { 観点: ["数と計算", "方程式", "関数", "図形", "資料の活用"], 平均: [70, 60, 50, 65, 55], grade1: [ { q: "問1. 3/4 + 1/4 を計算しなさい。", options: ["1", "1/2", "3/8"], a: "1", c: "数と計算" }, { q: "問2. 1.25 × 4 を計算しなさい。", options: ["5", "4.8", "5.25"], a: "5", c: "数と計算" }, { q: "問3. 三角形の3つの角の合計は何度ですか？", options: ["180度", "90度", "360度"], a: "180度", c: "図形" }, { q: "問4. 5 × (□ + 2) = 20 のとき、□に入る数は？", options: ["2", "3", "4"], a: "2", c: "方程式" }, { q: "問5. 時速60kmで2時間走ったときの距離は？", options: ["120km", "60km", "30km"], a: "120km", c: "関数" }, { q: "問6. 百分率25%を分数で表すと？", options: ["1/4", "1/2", "1/5"], a: "1/4", c: "数と計算" }, { q: "問7. 半径5cmの円の面積は？ (円周率は3.14とする)", options: ["78.5cm²", "31.4cm²", "15.7cm²"], a: "78.5cm²", c: "図形" }, { q: "問8. 10, 20, 30, 40, 50の平均値は？", options: ["30", "25", "35"], a: "30", c: "資料の活用" }, { q: "問9. 正六面体（立方体）の辺の数は全部で何本ですか？", options: ["12本", "6本", "8本"], a: "12本", c: "図形" }, { q: "問10. 5000円の10%引きの金額はいくらですか？", options: ["4500円", "4000円", "4950円"], a: "4500円", c: "数と計算" }, { q: "問11. 1時間は何分ですか？", options: ["60分", "100分", "30分"], a: "60分", c: "数と計算" }, { q: "問12. 台形の面積を求める公式は？", options: ["(上底+下底)×高さ÷2", "底辺×高さ÷2", "たて×横"], a: "(上底+下底)×高さ÷2", c: "図形" }, { q: "問13. 100の約数の個数は？", options: ["9個", "8個", "10個"], a: "9個", c: "数と計算" }, { q: "問14. サイコロを1回振ったとき、偶数の目が出る確率は？", options: ["1/2", "1/3", "1/6"], a: "1/2", c: "資料の活用" }, { q: "問15. 12と18の最大公約数は？", options: ["6", "3", "12"], a: "6", c: "数と計算" }, { q: "問16. □ - 1.5 = 3.5 のとき、□に入る数は？", options: ["5", "4", "2"], a: "5", c: "方程式" }, { q: "問17. 直方体の体積の求め方は？", options: ["たて×横×高さ", "たて×横", "(たて+横)×2"], a: "たて×横×高さ", c: "図形" }, { q: "問18. 3:5 と同じ比になるのは？", options: ["6:10", "5:3", "3:10"], a: "6:10", c: "関数" }, { q: "問19. データ [1, 2, 2, 3, 3, 3, 4] の最頻値（モード）は？", options: ["3", "2", "2.5"], a: "3", c: "資料の活用" }, { q: "問20. 20の3/5はいくつですか？", options: ["12", "10", "15"], a: "12", c: "数と計算" } ], grade2: [ { q: "問1. (+5) + (-8) を計算しなさい。", options: ["-3", "3", "13"], a: "-3", c: "数と計算" }, { q: "問2. 3x = 12 のとき、xの値は？", options: ["4", "3", "9"], a: "4", c: "方程式" }, { q: "問3. (-4) × (-6) を計算しなさい。", options: ["24", "-24", "10"], a: "24", c: "数と計算" }, { q: "問4. 比例 y = 2x で、x=5 のときのyの値は？", options: ["10", "7", "2.5"], a: "10", c: "関数" }, { q: "問5. 半径が5cmの円の面積は？(円周率はπとする)", options: ["25π cm²", "10π cm²", "5π cm²"], a: "25π cm²", c: "図形" }, { q: "問6. x + 7 = 3 を解きなさい。", options: ["x = -4", "x = 4", "x = 10"], a: "x = -4", c: "方程式" }, { q: "問7. 1, 3, 5, 7, 9 の平均値は？", options: ["5", "4", "6"], a: "5", c: "資料の活用" }, { q: "問8. 角柱の底面の形が五角形のとき、この角柱の名称は？", options: ["五角柱", "五角錐", "六角柱"], a: "五角柱", c: "図形" }, { q: "問9. 反比例 y = 12/x で、x=3 のときのyの値は？", options: ["4", "3", "12"], a: "4", c: "関数" }, { q: "問10. データの中で最も頻繁に出てくる値を何というか？", options: ["最頻値(モード)", "中央値(メジアン)", "平均値"], a: "最頻値(モード)", c: "資料の活用" }, { q: "問11. (-2)³ を計算しなさい。", options: ["-8", "8", "-6"], a: "-8", c: "数と計算" }, { q: "問12. 5x - 4 = 11 を解きなさい。", options: ["x = 3", "x = 1", "x = 5"], a: "x = 3", c: "方程式" }, { q: "問13. 比例 y = -3x のグラフは、どの象限を通りますか？", options: ["第2, 4象限", "第1, 3象限", "第1, 2象限"], a: "第2, 4象限", c: "関数" }, { q: "問14. 中心角が60度、半径が6cmのおうぎ形の弧の長さは？(円周率はπとする)", options: ["2π cm", "π cm", "6π cm"], a: "2π cm", c: "図形" }, { q: "問15. 階級の幅が10で、階級値が35の階級は？", options: ["30以上40未満", "35以上45未満", "25以上35未満"], a: "30以上40未満", c: "資料の活用" }, { q: "問16. 3x + 5 - x - 8 を簡単にしなさい。", options: ["2x - 3", "3x - 3", "2x + 3"], a: "2x - 3", c: "数と計算" }, { q: "問17. 1次方程式 0.5x + 1 = 2.5 を解きなさい。", options: ["x = 3", "x = 5", "x = 7"], a: "x = 3", c: "方程式" }, { q: "問18. yがxに反比例し、x=2 のとき y=6 である。この関係を式で表しなさい。", options: ["y = 12/x", "y = 3x", "y = 8/x"], a: "y = 12/x", c: "関数" }, { q: "問19. 底面の半径が3cm, 高さが10cmの円柱の体積は？(円周率はπとする)", options: ["90π cm³", "30π cm³", "60π cm³"], a: "90π cm³", c: "図形" }, { q: "問20. あるテストの5人の点数が 60, 70, 80, 80, 90 であった。中央値(メジアン)は？", options: ["80点", "75点", "76点"], a: "80点", c: "資料の活用" } ], grade3: [ { q: "問1. 2x + 3y + 5x - y を計算しなさい。", options: ["7x + 2y", "7x + 3y", "8xy"], a: "7x + 2y", c: "数と計算" }, { q: "問2. 連立方程式 x+y=5, x-y=1 の解は？", options: ["x=3, y=2", "x=2, y=3", "x=4, y=1"], a: "x=3, y=2", c: "方程式" }, { q: "問3. 一次関数 y = 3x - 2 のグラフの傾きは？", options: ["3", "-2", "1"], a: "3", c: "関数" }, { q: "問4. n角形の内角の和を求める公式は？", options: ["180(n-2)", "180n", "360(n-2)"], a: "180(n-2)", c: "図形" }, { q: "問5. 2つのサイコロを同時に投げるとき、目の和が7になる確率は？", options: ["1/6", "1/12", "1/36"], a: "1/6", c: "資料の活用" }, { q: "問6. 5x - 3 = 2x + 6 を解きなさい。", options: ["x = 3", "x = 1", "x = -3"], a: "x = 3", c: "方程式" }, { q: "問7. 一次関数 y = -x + 5 で、xが2増加するときのyの増加量は？", options: ["-2", "2", "3"], a: "-2", c: "関数" }, { q: "問8. 合同な図形の性質として間違っているものは？", options: ["面積は異なる場合がある", "対応する辺の長さは等しい", "対応する角の大きさは等しい"], a: "面積は異なる場合がある", c: "図形" }, { q: "問9. (2a²b) × 3ab を計算しなさい。", options: ["6a³b²", "5a³b²", "6a²b"], a: "6a³b²", c: "数と計算" }, { q: "問10. あるクラスのテストの点数の中央値(メジアン)が75点だった。これは何を意味するか？", options: ["データを小さい順に並べたとき真ん中にくる値", "最も多くの生徒がとった点数", "全員の点数の合計を人数で割った値"], a: "データを小さい順に並べたとき真ん中にくる値", c: "資料の活用" }, { q: "問11. 4x²y ÷ 2xy を計算しなさい。", options: ["2x", "2y", "2xy"], a: "2x", c: "数と計算" }, { q: "問12. 連立方程式 y=2x, x+y=9 の解は？", options: ["x=3, y=6", "x=2, y=4", "x=1, y=2"], a: "x=3, y=6", c: "方程式" }, { q: "問13. 一次関数 y = 2x + 3 のグラフがy軸と交わる点の座標は？", options: ["(0, 3)", "(3, 0)", "(0, 2)"], a: "(0, 3)", c: "関数" }, { q: "問14. 二等辺三角形の性質として正しいものは？", options: ["2つの底角は等しい", "すべての角が等しい", "すべての辺が等しい"], a: "2つの底角は等しい", c: "図形" }, { q: "問15. 赤玉3個、白玉2個が入った袋から玉を1個取り出すとき、赤玉が出る確率は？", options: ["3/5", "2/5", "1/5"], a: "3/5", c: "資料の活用" }, { q: "問16. 3(x - 2y) - 2(x - y) を計算しなさい。", options: ["x - 4y", "x - 8y", "5x - 8y"], a: "x - 4y", c: "数と計算" }, { q: "問17. 不等式 3x + 5 > 11 を解きなさい。", options: ["x > 2", "x < 2", "x > 16/3"], a: "x > 2", c: "方程式" }, { q: "問18. 2点(-1, 1), (2, 7)を通る直線の式を求めなさい。", options: ["y = 2x + 3", "y = 3x + 4", "y = x + 2"], a: "y = 2x + 3", c: "関数" }, { q: "問19. 平行四辺形になるための条件として間違っているものは？", options: ["対角線が直角に交わる", "2組の対辺がそれぞれ平行", "2組の対角がそれぞれ等しい"], a: "対角線が直角に交わる", c: "図形" }, { q: "問20. 箱ひげ図で、箱の長さが表すものは？", options: ["四分位範囲", "範囲", "平均値"], a: "四分位範囲", c: "資料の活用" } ] } };
